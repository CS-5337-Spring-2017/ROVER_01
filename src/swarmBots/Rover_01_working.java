...
public class Rover_01_working  extends Rover {


	public Rover_01_working() {
		// constructor
		System.out.println("Rover_01_working  rover object constructed");
		rovername = "Rover_01_working ";
	}
	
	public Rover_01_working (String serverAddress) {
		// constructor
		System.out.println("Rover_01_working  rover object constructed");
		rovername = "Rover_01_working ";
...
//				System.out.println("Rover_01_working  ------------ bottom process control --------------"); 
		...
		// This catch block closes the open socket connection to the server
	        ...
	        if (socket != null) {
	            try {
	            	...
	            	System.out.println("Rover_01_working  problem closing socket");
	            }
	        }
	    }
